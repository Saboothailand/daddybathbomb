...
export default function ContactPage({ language, navigateTo }: ContactPageProps) {
  ...
  const texts = {
    th: {
      ...
      description: 'มีคำถามหรือต้องการสอบถามข้อมูล? ทีมงานของเราพร้อมให้บริการและตอบคำถามทุกข้อสงสัย',
    ...
    en: {
      ...
      description: 'Have questions or need information? Our team is ready to serve and answer all your inquiries',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Banner Section - 높이 증가 및 텍스트 가독성 개선 */}
      <div className="relative h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
        <div 
          className="absolute inset-0 bg-cover bg-center"
          style={{ 
            backgroundImage: `url(https://images.unsplash.com/photo-1596524430615-b46475ddff6e?q=80&w=2340&auto=format&fit=crop)`,
          }}
        />
        {/* 더 강한 오버레이로 텍스트 가독성 향상 */}
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={language === 'th' ? 'หัวข้อข้อความ' : 'Subject'}
                    />
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
              ...
              <div className="p-6 space-y-4">
                {contactItems.map((item, index) => (
                  ...
                  >
                    <div className={`w-12 h-12 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform`}>
                      {item.icon}
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="text-xs font-semibold text-gray-500 uppercase tracking-wider">{item.title}</div>
