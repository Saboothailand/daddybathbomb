...
-- 5. 결과 확인
SELECT 'banner_images' as table_name, position, COUNT(*) as count FROM public.banner_images GROUP BY position
UNION ALL
SELECT 'banner_clicks' as table_name, 'all' as position, COUNT(*) as count FROM public.banner_clicks;
